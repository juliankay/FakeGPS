...
Description:
    ...
    This module contains the implementation of the sensors service driver's
    entry point and its exported functions for providing COM support.

    This module is dependent on the following defines:

        MYDRIVER_TRACING_ID -   A wide string passed to WPP when initializing tracing.

--*/

#include "Internal.h"
#include "FakeGPSModule.tmh"

class CFakeGPSModule : public CAtlDllModuleT<CFakeGPSModule> {} _AtlModule;
...
Return Values:
    ...
    S_FALSE: Unregistration of known entries was successful, but other entries still exist for this server's classes
