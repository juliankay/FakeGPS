...
#define LONG_REPORT_INTERVAL_MS 5 * 60000   // Number of milliseconds where a report interval
                                            // is long enough that the device should be
                                            // powered down.
#define DEVICE_STARTUP_MS 60000             // Average number of milliseconds it takes the
...
CSensor::CSensor()
{
    ...
    m_fInitialDataReceived = FALSE;             // flag checks to see if initial poll request was fulfilled
