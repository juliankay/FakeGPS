...
Description:
    ...
    This module contains the local type definitions for the sensors service driver.
...
// Macro letting the compiler know this is not a kernel driver (this will help suppress needless warnings)
...
// {3BA2B796-FACE-FEED-9F8E-62A38E444208}
DEFINE_GUID(GUID_DEVINTERFACE_GPS_RADIO_MANAGEMENT,
    0x3ba2b796, 0xface, 0xfeed, 0x9f, 0x8e, 0x62, 0xa3, 0x8e, 0x44, 0x42, 0x8);

#define IOCTL_INDEX                         0x800
#define FILE_DEVICE_GPS_RADIO_MANAGEMENT    0x64911 // TODO: Pick a semi-unique value
...
#define PROP_STORE_KEY_LATITUDE             L"SENSOR_PROPERTY_LATITUDE"
#define PROP_STORE_KEY_LONGITUDE            L"SENSOR_PROPERTY_LONGITUDE"
...
// Module defines
const unsigned char MODULE_NAME [] = "FakeGPS.dll";    // VER_ORIGINALFILENAME_STR

// Default values
const unsigned short DEFAULT_DEVICE_MODEL_VALUE [] = L"FakeGPS Driver";
const unsigned short DEFAULT_SERIAL_NUMBER [] = L"57E940BB-A3ED-BEEF-9722-A605392668E4";
const unsigned short DEFAULT_MANUFACTURER [] = L"Julian Kay";
